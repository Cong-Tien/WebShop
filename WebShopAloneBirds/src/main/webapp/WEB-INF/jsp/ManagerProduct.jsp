            ...
            <div   class="modal-dialog">
                <div  class="modal-content">
                    <form action="newproduct" method="post">
                        ...
                        <div style="background-color: pink; color: white;" class="modal-header">						
                            <h4 class="modal-title"><i>New Product</h4></i>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input style="border-radius: 20px;border:2px solid pink" name="name" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label style="color: hotpink;">Image</label>
                                <input style="border-radius: 20px;border:2px solid pink" name="image" type="file" class="form-control" required>
                            </div>
                             <div class="form-group">
                                <label style="color: hotpink;">Image_ad</label>
                                <input style="border-radius: 20px;border:2px solid pink" name="image_ad" type="file" class="form-control" required>
                            </div>
                            <div  class="form-group">
                                <label style="color: hotpink;">Price</label>
                                <input style="border-radius: 20px;border:2px solid pink" name="price" type="type" placeholder="Choose Image" class="form-control" required>
                            </div>
                            
                            <div class="form-group">
                                <label style="color: hotpink;">Category</label>
                                <select style="width:300px;height: 35px;border-radius: 20px;border:2px solid pink" name="category" class="form-select" aria-label="Default select example">
